	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a class="fa fa-facebook"href="https://www.facebook.com/profile.php?id=100051419000797"></a>
                <a class="fa fa-twitter"href="https://www.twitter.com"></a>
                <a class="fa fa-google"href="https://duytan.edu.vn"></a>
                <a class="fa fa-youtube"href="https://www.youtube.com/@DuyTanUniversity"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/trangchu.png" alt="Trang chủ " title="Trang chủ ">
            </a>
        </div> <!-- End Logo -->
